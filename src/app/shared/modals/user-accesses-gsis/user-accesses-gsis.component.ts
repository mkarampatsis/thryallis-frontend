...
@Component({
  selector: 'app-user-accesses-gsis',
  standalone: true,
  imports: [    
    CommonModule, 
    AgGridAngular, 
  ...
  templateUrl: './user-accesses-gsis.component.html',
  styleUrl: './user-accesses-gsis.component.css'
})
export class UserAccessesGsisComponent {
  ...
  onSubmit() {
    this.userService.setUserAccessesGSIS(this.user?.taxid as string, this.currentRoles as IUserRole[])
      .pipe(take(1))
      .subscribe((result) => {
