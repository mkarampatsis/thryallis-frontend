...
export class ConstService {
  ...
  readonly USER_ROLES = ['EDITOR', 'HELPDESK', 'HELPDESK_OTA', 'ADMIN', 'FACILITY_EDITOR', 'FACILITY_ADMIN', 'EQUIPMENT_EDITOR', 'EQUIPMENT_ADMIN', 'OTA_EDITOR', 'OTA_ADMIN', 'USER_RESOURCES_EDITOR', 'USER_RESOURCES_ADMIN']
