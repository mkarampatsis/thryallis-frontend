...
export class OrganizationService {
  ...
  getTreeSdad(code: string): Observable<IOrganizationTreeSdadNode[]> {
    return this.http.get<IOrganizationTreeSdadNode[]>(`${APIPREFIX_PSPED}/${code}/treeSdad`);
  }
}
