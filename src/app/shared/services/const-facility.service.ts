...
export class ConstFacilityService {
  ...
  //       "Άλλο",
  //     ],  
  //     "Πύργος Ελέγχου και συναφή κτίρια":[
  ...
  //       "Άλλο",
  //     ],
  //     "Τεχνική Βάση και συναφή κτίρια":[
  //       "Υπόστεγο συντήρησης",
  //       "Αποθηκευτικός χώρος εξοπλισμού - ανταλλακτικών κτλ.",
  //       "Χώρος γραφείων (υπηρεσίες)",
  //       "Άλλο",
  //     ],
  //     "Εμπορευματικός σταθμός – Cargo και συναφή κτίρια":[
  ...
  //     ],
  //     "Άλλη Εγκατάσταση Αερολιμένα":[
  //       "Άλλο"
  //     ]
  //   ],
  //   "Λιμένας":[
  //     "Ζώνη υποδοχής/ελλιμενισμού πλοίων":[
  //       "Προβλήτα (Ντόκος)",
  //       "Πλωτές εξέδρα",
  //       "Λεκάνη ελιγμών (Turning Basin)",
  //       "Άλλο",
  //     ],
  //     "Ζώνη Φόρτωσης, Εκφόρτωσης και Αποθήκευσης":[
  ...
  //       "Άλλο",
  //     ],
  //     "Χώροι συγκοινωνιών και δικτύων μεταφορών λιμένα ":[
  ...
  //       "Άλλο",
  //     ],
  //     "Διοίκηση και Λοιπές Εγκαταστάσεις ":[
  //       "Λιμενικός σταθμός",
  ...
  //       "Άλλο",
  //     ],
  //     "Ναυπηγοεπισκευαστικές Εγκαταστάσεις":[
